...
function sayHellotypescript(helloObj) {
...
console.log(' '); // hello im a spacer :D
function checkAgetypescript(peepArray) {
...
console.log(' '); // hello im a spacer :D
function veggietalesTypescript(veggietalesObj) {
...
console.log(' '); // hello im a spacer :D
function getLength(stringObj) {
    var stringLength = stringObj.string.length;
